...
module _Tile =
    ...
    type PageTilingDistincter = 
        | TextCase of (PageModifingArguments<unit> -> Bound -> IntegratedTextRenderInfo list -> IComparable) * (PageTilingDistincterInfo list -> PageTilingDistincterInfo list)
    with 
