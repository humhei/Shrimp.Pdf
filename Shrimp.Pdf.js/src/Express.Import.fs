...
module express =
    ...
    and Response =
        ...
        abstract render: view: string * ?options: obj * ?callback: Func<obj, string, unit> -> unit
        abstract render: view: string * ?callback: Func<obj, string, unit> -> unit
    ...
    and Application =
        ...
        abstract engine: ext: string * fn: obj -> Application
        ...
        abstract configure: fn: obj -> Application
        abstract configure: env0: string * fn: obj -> Application
        abstract configure: env0: string * env1: string * fn: obj -> Application
        abstract configure: env0: string * env1: string * env2: string * fn: obj -> Application
        abstract configure: env0: string * env1: string * env2: string * env3: string * fn: obj -> Application
        abstract configure: env0: string * env1: string * env2: string * env3: string * env4: string * fn: obj -> Application
        abstract render: name: string * ?options: obj * ?callback: Func<obj, string, unit> -> unit
        abstract render: name: string * callback: Func<obj, string, unit> -> unit
        abstract listen: port: int * hostname: string * backlog: float * ?callback: obj -> Http.Server
        abstract listen: port: int * hostname: string * ?callback: obj -> Http.Server
        abstract listen: port: int * ?callback: obj -> Http.Server
        abstract listen: path: string * ?callback: obj -> Http.Server
        abstract listen: handle: obj * ?listeningListener: obj -> Http.Server
        abstract route: path: string -> IRoute
    ...
    type Globals =
        ...
        [<Emit("express.json()")>] member __.json(): RequestHandler = jsNative
